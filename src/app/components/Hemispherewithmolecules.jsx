 ...
 function onhandleclick5(){
  ...
  return (
    <div className="relative ">
      ...
      <div
        className={`absolute h-20 hidden lg:block w-20 lg:w-full z-20 md:left-[32%] md:top-[20%] lg:left-[0%] xl:left-[0%] lg:top-[400px] xl:top-[600px] 2xl:top-[700px] 2xl:pl-40`} 
      >
