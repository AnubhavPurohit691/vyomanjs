...
const ProfileCard = ({ name, position, link, src }) => {
  return (
    <div className="flex h-64 mb-0 flex-col justify-between border-[1px] border-gray-200 md:h-80 lg:h-72 xl:h-[400px]">
      {/* Name and Position */}
      <div className="flex justify-around gap-8 border-b-2 border-gray-200 p-4 pr-0 pl-3 sm:gap-3 sm:pl-5 md:gap-8 md:pl-6 lg:justify-around lg:gap-4 lg:pl-4 xl:gap-8 2xl:gap-20 2xl:pl-12">
...
const ProfileCardList = () => {
  ...
  return (
    <div className="container mx-auto  mt-[3rem] px-4  sm:mt-[10rem] sm:pl-1 sm:pr-10 md:pl-20 md:mt-[12rem] lg:ml-0 lg:mt-20 lg:pl-20 lg:pr-16 xl:mt-40 xl:pl-60 xl:pr-0 2xl:mt-0 2xl:pl-12 2xl:pt-0">
