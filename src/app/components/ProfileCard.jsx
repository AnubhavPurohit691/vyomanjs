...
const ProfileCardList = () => {
  ...
  return (
    <div className="container mx-auto  mt-[3rem] px-2  sm:mt-[10rem] sm:pl-1 sm:pr-10 md:pl-20 md:mt-[12rem] lg:ml-0 lg:mt-20 lg:pl-20 lg:pr-16 xl:mt-40 xl:pl-60 xl:pr-0 2xl:mt-0 2xl:pl-12 2xl:pt-0">
      ...
      <div className="grid grid-cols-1 mt-8 md:mt-12 sm:grid-cols-2 lg:grid-cols-3 2xl:mt-10">
