...
const Accordion = () => {
  ...
  return (
    <div className="mt-[39rem] md:mt-[55rem] lg:mt-28 lg:pr-24 w-screen pl-10 md:pl-16 md:pr-16 pr-10 lg:pl-24 xl:mt-52 xl:pl-[12rem] xl:pr-[12rem] 2xl:mt-60 2xl:pl-72">
        ...
        <div key={item.id} className="mb-4 xl:mb-0 pb-8 xl:p-0  border-b-[1px] w-full  border-gray-200">
          ...
          >
            <div className="flex justify-between  ">
              ...
              > 
              <div className='flex gap-6 lg:ml-10 xl:ml-32 '><Image src={item.image} alt='image' className={`  ${isOpen === item.id ? 'hidden' : 'hidden lg:block lg:rounded-full lg:bg-gray-300 lg:-mt-6 lg:h-20 lg:w-20 lg:p-3'
                }`} />
               <div className=' md:text-xl ml-1 mb-3'> {isOpen === item.id ? '' : item.title} </div> 
                </div>
              </h1>
              </div>
              ...
              <Image
                src={arrow}
                alt="arrow"
                className={`rotate-180 h-4 w-4 mt-6   ${
                  isOpen === item.id ? 'hidden' : ''
                }`}
              />
            </div>
          ...
          {isOpen === item.id && (
            <div className="relative">
              <div className="grid columns-3 ">
                ...
                <div className="text-end xl:w-60 xl:ml-[900px] ">{item.description}</div>
                <div className=" h-44 w-44  md:h-64 md:w-64 ml-20 mt-6 flex xl:ml-96 xl:mt-0 xl:mb-10  lg:h-80 lg:w-80  overflow-hidden rounded-full bg-gray-300 p-4">
