...
const Accordion = () => {
  ...
  return (
    <div className="mt-[42rem] md:mt-[55rem] w-screen lg:mt-28 lg:pr-24 w-screen pl-10 md:pl-16 md:pr-16 pr-10 lg:pl-24 xl:mt-52 xl:pl-[12rem] xl:pr-[12rem] 2xl:mt-60 2xl:pr-[15rem] 2xl:pl-72">
